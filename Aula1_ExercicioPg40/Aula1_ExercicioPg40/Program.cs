...
namespace Aula1_ExercicioPg40
{
    class Program
    {
        static void Main(string[] args)
        {
            string nome = "Thiago", sobrenome = "souza", completo;
            ...
            Console.Write("9) " + nome + " substring iniciando na posicao 2 e pegando 2 caracteres = " + nome.Substring(2, 2));
